                    ...
                    <div className="lg:w-1/2 md:w-1/2 lg:-mt-12">
                        <div className="flex h-full">
                            <div className="w-full px-8 py-10 bg-black">
                                ...
                                <a href="#"
                                   className="inline-flex items-center p-4 mt-4 font-black text-white duration-500 ease-in-out border-b text-1xl ransition group-hover:text-black bg-gradient-to-tr from-blue to-pink md:mb-2 lg:mb-0 hover:text-blue ">
                                    his twitter
