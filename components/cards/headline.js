            ...
            <Link href="/detail-page"><a>
                <div className="flex h-full">
                    <div
                        ...
                        <div
                            className="inline-flex items-center p-4 mt-4 font-black text-white duration-500 ease-in-out border-b text-1xl transition group-hover:text-black bg-gradient-to-tr from-blue-900 to-pink-900 md:mb-2 lg:mb-0 hover:text-blue ">
                            Read it
